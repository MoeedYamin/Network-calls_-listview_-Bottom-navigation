...
import com.example.task2_network_calls_listviews_bottom_navigation_fragment_local_dbv__viewmodel.Fragments.ApiFragment
import com.example.task2_network_calls_listviews_bottom_navigation_fragment_local_dbv__viewmodel.Fragments.FireStoreFragment
import com.example.task2_network_calls_listviews_bottom_navigation_fragment_local_dbv__viewmodel.Fragments.LocalDbFragment
...
class MainScreen : AppCompatActivity() {
    ...
    private fun bottomNavigationBar() {
        ...
        binding.fireStoreLayout.setOnClickListener(View.OnClickListener {
            ...
            if (selectedTab != 1) {
                supportFragmentManager.beginTransaction().setReorderingAllowed(true)
                    .replace(R.id.fragments, FireStoreFragment::class.java, null)
                    .commit()
        ...
        binding.apiLayout.setOnClickListener(View.OnClickListener {
            ...
            if (selectedTab != 2) {
                supportFragmentManager.beginTransaction().setReorderingAllowed(true)
                    .replace(R.id.fragments, ApiFragment::class.java, null)
                    .commit()
        ...
        binding.localDbLayout.setOnClickListener(View.OnClickListener {
            ...
            if (selectedTab != 3) {
                supportFragmentManager.beginTransaction().setReorderingAllowed(true)
                    .replace(R.id.fragments, LocalDbFragment::class.java, null)
                    .commit()
                binding.fireStoreText.visibility = View.GONE
                binding.apiText.visibility = View.GONE

                binding.fireStoreImage.setImageResource(R.drawable.firestore)
                binding.apiImage.setImageResource(R.drawable.local_db)
